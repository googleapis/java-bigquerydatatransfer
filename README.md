...
```Groovy
implementation 'com.google.cloud:google-cloud-bigquerydatatransfer:2.0.13'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-bigquerydatatransfer" % "2.0.13"
```
...
Samples are in the [`samples/`](https://github.com/googleapis/java-bigquerydatatransfer/tree/master/samples) directory.
